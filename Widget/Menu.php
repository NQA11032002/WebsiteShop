        ...
        <div id="header">
            <nav class="container">
                <ul id="main-menu">
                    ...
                    <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Tất Cả&IDLoai=-1">Sản Phẩm</a>
                        <ul class="sub-menu">
                            <li><a href="SanPham.php?page=Quần Áo&TheLoai=Đồ Nam&IDLoai=14">Đồ Nam</a></li>
                            <li><a href="SanPham.php?page=Quần Áo&TheLoai=Đồ Nữ&IDLoai=15">Đồ Nữ</a></li>
                            <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Áo&IDLoai=1">Áo</a></li>
                            <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Quần&IDLoai=2">Quần</a></li>
                            <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Ba Lô&IDLoai=4">Ba Lô</a></li>
                            <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Giày&IDLoai=3">Giày</a></li>
                            <li><a href="SanPham.php?page=Sản Phẩm&TheLoai=Mũ&IDLoai=5">Mũ</a></li>
                        </ul>
                    </li>
