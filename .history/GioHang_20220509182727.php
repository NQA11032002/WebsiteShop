...
<?php
    ...
    $queryDonHang = "select dh.IDSP,dh.ID, sp.imageSP,sp.tenSP, (sp.giaSP - sp.giaGiam) as giaSP, tl.tenTL, dh.soLuongDat, dh.size, dh.tongTien as soTien 
                    from giohang as dh 
...
<body>
    <div class="Main_Cart">
        ...
        <div class="Title_Cart">
            <img src="/QuanLyShop/Image/Icon/ShoppingCart.png" alt="">
            <h1>Giỏ Hàng Wibugangz</h1>
        </div>
                        ...
                        $total = 0;
                            ...
                            ?>    
                                <tr>
									...
									<td><?php echo format_money($row['giaSP']?)>
                                    <td><?php echo $row['size']?>
									<td><?php echo $row['soLuongDat']?>
                                    <td><?php echo $row['soTien']?>
