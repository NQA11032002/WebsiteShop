...
function format_money($number , $decimals = 0 , $dec_point = "" , $thousands_sep = "",$unit = "đ" ) {
    return number_format($number,$decimals,$dec_point,$thousands_sep)."<span style="text-decoration:underline;>{$unit}";
}
?>