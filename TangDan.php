...
<?php
    ...
    if($brand != null)
    {
        $command = "SELECT * FROM `sanpham` WhERE brand = '".$brand."' ORDER BY giaSP";
    }
    else
    {
        if($IDLoai != -1)
	        $command = "SELECT * FROM `sanpham` WhERE IDLoai = '".$IDLoai."' ORDER BY giaSP";
        else                                                
            $command = "SELECT * FROM `sanpham` ORDER BY giaSP"; 
    }
